...
class ChatBotWrapper:
    ...
    def generate_chatbot_feedback_prompt(self, *, topic: str, code: str, explanation: str) -> str:
        ...
        *,
        ...
        request_payload = {
            "contents": [
                {
                    "parts": [
                        {"text": self.generate_chatbot_feedback_prompt(topic=topic, code=code, explanation=explanation)}
                    ]
                }
            ]
        }
